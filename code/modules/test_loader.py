...
def test_load():
    ...
    try:
        ...
        meta_data = pd.read_parquet(f'{BASE_PATH}/data/expression/v_0.01/meta_data.parquet')
        ...
        # Test matrix
        print("\nTesting matrix:")
        matrix = scipy.io.mmread(f'{BASE_PATH}/data/expression/v_0.01/normalized_data.mtx')
        ...
        genes = pd.read_parquet(f'{BASE_PATH}/data/expression/v_0.01/genes.parquet')
        meta_data = pd.read_parquet(f'{BASE_PATH}/data/expression/v_0.01/meta_data.parquet')
        meta_data = meta_data[["new_cell_type", "sample", "Age_numeric", "sc_sn_atac", 
                              "Comp_sex", "Name", "Author", "Normal", "SRA_ID"]]
